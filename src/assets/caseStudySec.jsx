...
export const cardData = [
  ...
  { title: "Metaverse", subtitle: "for Real Estate" },
  { title: "CRM", subtitle: "for Media" },
  { title: "ERP", subtitle: "for Logistics" },
  { title: "Custom App", subtitle: "for Gaming" },
];
...
export const caseContents = [
  ...
  {
    title: "NielSen",
    description: "A new case study focusing on market research and consumer insights.",
    stats: ["50% Increased Engagement", "10K+ Surveys Conducted"],
    button: "Read NielSen Case Study",
  },
  {
    title: "SML ISUZU",
    description: "Description of the new case study.",
    stats: ["Stat 1", "Stat 2"],
    button: "Read New Case Study",
  },
  {
    title: "Custom App",
